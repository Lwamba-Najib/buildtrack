...
```
cd existing_repo
git remote add origin https://gitlab.com/joel0hudson/buildtrack.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/joel0hudson/buildtrack/-/settings/integrations)
