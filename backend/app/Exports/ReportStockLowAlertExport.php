...
class ReportStockLowAlertExport implements FromCollection, WithHeadings, WithCustomStartCell, WithEvents, WithColumnFormatting
{
    ...
    public function collection()
    {
        $query = StockBalance::with(['product', 'brand', 'measurement'])
            ...
            ->orderBy('stock_balances.balance', 'ASC')
            ->get();
    ...
    {
        return [
            'E' => NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1, // MIN STOCK LEVEL
            'F' => NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1, // QTY IN STOCK
            'G' => NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1, // UNIT PRICE
            'H' => NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1  // TOTAL VALUE
        ];
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->setCellValue('A1', 'Stock Low Alert Report');
                $event->sheet->setCellValue('A2', 'Generated on: ' . now()->format('M d, Y h:i A'));
                ...
                // Style number columns to right-align (columns E-H)
