...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('APP_NAME', 'buildtrack-backup'),
        ...
        'destination' => [
            ...
            env('APP_ENV') === 'production' ? [] : [
                'local' => [
                    'disks' => ['local'], // Only back up if not in production
                ],
            ],
        ],
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => 'joel0hudson@gmail.com',

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'cryptechlimited@gmail.com'),
                'name' => env('MAIL_FROM_NAME', 'Build Track'),
            ],
        ],
