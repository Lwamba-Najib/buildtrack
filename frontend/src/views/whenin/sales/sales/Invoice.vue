...
const printInvoice = () => {
    // Get the printable invoice content
    const printOut = document.getElementById('printable-invoice').innerHTML;
                                                                    ...
                                                                    <tr style="line-height: 2;">
                                                                        ...
                                                                        <td class="text-end" style="border: none;">
                                                                            <p class="text-end m-0">
                                                                                Date: <u><span class="pl-5">{{ parseDate(sale.created_at) || 'NA' }}</span></u><br>
                                                                                Invoice#: <u><span class="text-bold pl-5">{{ sale.batch_number }}</span></u>
                                                                            </p>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr class="no-border">
                                                                                <td colspan="2" class="no-bottom-border" style="border: none;">
                                                                                    <h5>Notes:</h5>
                                                                                    <div style="width: 100%; height: 120px; border: 2px solid #000; padding: 5px;">{{ sale.notice || '' }}</div>
                                                                                </td>
                                                                                <td class="text-end" style="border: none; flex-direction: column;  padding: 0px;">
                                                                                    ...
                                                                                    <div style="padding-top: 10px; padding-right: 5px;">TAX: </div>
                                                                                    <div style="padding-top: 10px; padding-right: 5px;">SHIPPING: </div>
                                                                                ...
                                                                                <td class="text-end" style=" flex-direction: column; border: 1px solid #000; padding: 0px;">
                                                                                    ...
                                                                                    <div style="border-bottom: 1px solid #000; border-left: 1px solid #000; border-right: 1px solid #000; padding: 5px;">{{ formatCurrency(0) }}</div>
                                                                            ...
                                                                            <tr class="no-border">
                                                                                <td colspan="6" class="text-center align-middle" style="border: none;">
                                                                                    <h6 class="text-red">THANK YOU FOR YOUR BUSINESS!</h6>
                                                                                    <hr class="seperator-line"/>
                                                                                    <small>
...
@media print {
    ...
    * {
    ...
    #header:before {
        content: " Thank you for printing our invoice." !important;
        color: #777 !important;
        font-size: 1em !important;
        padding-top: 30px !important;
