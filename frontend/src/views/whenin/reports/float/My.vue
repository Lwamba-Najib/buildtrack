...
const fetchDetails = async () => {
    ...
    try {
        ...
        const response = await axios.get(`/floatreportshow/${clientId.value}`, {
            headers: {
...
const fetchTotalCredits = async (mno = null) => {
    ...
    try {
        ...
        let url = `/floatreporttotalcredit/${clientId.value}`;  // No need to include clientId in the URL
        if (mno) {
            url += `/${mno}`;
        }
...
const exportPDF = async () => {
    ...
    try {
        ...
        const response = await axios.get(`/floatreportmypdf/${clientId.value}`, {
            headers: {
        ...
        const filename = `${today}_floatreportmy_${id}.pdf`;
    ...
    <section>
        ...
        <div class="app-hero-header d-flex align-items-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <RouterLink to="/floatreportmy" class="text-decoration-none">Float Report</RouterLink>
                </li>
        ...
        <div class="app-body">
            ...
            <div class="row" 
                v-if="
					menuAccess.floatReportMyMaskToggle ||
					menuAccess.floatReportMyExport
				">
                        ...
                        <div class="card-body p-2">
                            <div class="d-flex justify-content-end my-1 my-lg-0">
                                <div class="d-flex flex-row gap-2">
                                    <button v-if="menuAccess.floatReportMyMaskToggle" @click="toggleMask" class="btn btn-sm btn-info d-flex align-items-center gap-2">
                                    <i :class="isMasked ? 'bi-eye-slash' : 'bi-eye'"></i>
                                    {{ isMasked ? "Unmask" : "Mask" }}
                                    </button>
                                    <div class="d-flex" v-if="menuAccess.floatReportMyExport">
                                        <div class="dropdown">
