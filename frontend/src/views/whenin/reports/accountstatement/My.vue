...
const fetchDetails = async () => {
    ...
    try {
        ...
        const response = await axios.get(`/accountstatementshow/${clientId.value}`, {
            headers: {
...
const fetchBalances = async (mno = null) => {
    ...
    try {
        ...
        let url = `/accountstatementbalance/${clientId.value}`;  // No need to include clientId in the URL
        if (mno) {
            url += `/${mno}`;
        }
...
const exportPDF = async () => {
    ...
    try {
        ...
        const response = await axios.get(`/accountstatementshowpdf/${clientId.value}`, {
            headers: {
    ...
    <section>
        ...
        <div class="app-hero-header d-flex align-items-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <RouterLink to="/accountstatementmy" class="text-decoration-none">Account Statement</RouterLink>
                </li>
        ...
        <div class="app-body">
            ...
            <div class="row" 
                v-if="
					menuAccess.accountStatementMyMaskToggle ||
					menuAccess.accountStatementMyExport
				">
                        ...
                        <div class="card-body p-2">
                            <div class="d-flex justify-content-end my-1 my-lg-0">
                                <div class="d-flex flex-row gap-2">
                                    <button v-if="menuAccess.accountStatementMyMaskToggle" @click="toggleMask" class="btn btn-sm btn-info d-flex align-items-center gap-2">
                                    <i :class="isMasked ? 'bi-eye-slash' : 'bi-eye'"></i>
                                    {{ isMasked ? "Unmask" : "Mask" }}
                                    </button>
                                    <div class="d-flex" v-if="menuAccess.accountStatementMyExport">
                                        <div class="dropdown">
