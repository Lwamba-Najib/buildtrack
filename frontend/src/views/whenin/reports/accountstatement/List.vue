...
const fetchClients = async (page = 1) => {
	...
	try {
		...
		const response = await axios.get("/accountstatementclientlist", {
			headers: {
...
const exportFile = async (fileType) => {
	...
	const urls = {
		xlsx: "/accountstatementxlsx",
		csv: "/accountstatementcsv",
	};
	...
	<section>
		...
		<div class="app-hero-header d-flex align-items-center">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item">
					<RouterLink to="/accountstatementlist" class="text-decoration-none"
						>Account Statements</RouterLink
					>
				</li>
		...
		<div class="app-body">
			...
			<div
				class="row"
				v-if="
					menuAccess.accountStatementListExport ||
					menuAccess.accountStatementListMaskToggle
				"
			>
						...
						<div class="card-body p-2">
							<div class="d-flex justify-content-end my-1 my-lg-0">
								<div class="d-flex flex-row gap-2">
									<button v-if="menuAccess.accountStatementListMaskToggle" @click="toggleMask" class="btn btn-sm btn-info d-flex align-items-center gap-2">
                                    <i :class="isMasked ? 'bi-eye-slash' : 'bi-eye'"></i>
                                    {{ isMasked ? "Unmask" : "Mask" }}
                                    </button>
									<div class="d-flex" v-if="menuAccess.accountStatementListExport">
										<div class="dropdown">
											<button
												type="button"
