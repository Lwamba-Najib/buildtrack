...
const fetchDetails = async () => {
    ...
    try {
        ...
        // Fetch the specific collection report by batch number
        const response = await axios.get(`/collectionreportshow/${route.params.id}`, {
            headers: {
...
const fetchTotalCredits = async (mno = null) => {
    ...
    try {
        ...
        let url = `/collectionreporttotalcredit/${route.params.id}`;  // No need to include clientId in the URL
        if (mno) {
            url += `/${mno}`;
        }
...
const exportPDF = async () => {
    ...
    try {
        ...
        const response = await axios.get(`/collectionreportshowpdf/${route.params.id}`, {
            headers: {
        ...
        const filename = `${today}_collectionreportshow_${id}.pdf`;
    ...
    <section>
        ...
        <div class="app-hero-header d-flex align-items-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <RouterLink to="/collectionreportlist" class="text-decoration-none">Collections Report</RouterLink>
                </li>
        ...
        <div class="app-body">
            ...
            <div class="row" 
                v-if="
					menuAccess.collectionReportShowMaskToggle ||
					menuAccess.collectionReportShowExport
				">
                        ...
                        <div class="card-body p-2">
                            <div class="d-flex justify-content-end my-1 my-lg-0">
                                <div class="d-flex flex-row gap-2">
                                    <button v-if="menuAccess.collectionReportShowMaskToggle" @click="toggleMask" class="btn btn-sm btn-info d-flex align-items-center gap-2">
                                    <i :class="isMasked ? 'bi-eye-slash' : 'bi-eye'"></i>
                                    {{ isMasked ? "Unmask" : "Mask" }}
                                    </button>
                                    <div class="d-flex" v-if="menuAccess.collectionReportShowExport">
                                        <div class="dropdown">
