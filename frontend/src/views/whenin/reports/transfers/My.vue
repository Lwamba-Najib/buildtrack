...
const fetchDetails = async () => {
    ...
    try {
        ...
        const response = await axios.get(`/transferreportshow/${clientId.value}`, {
            headers: {
...
const fetchTotalDebits = async (mno = null) => {
    ...
    try {
        ...
        let url = `/transferreporttotaldebit/${clientId.value}`;  // No need to include clientId in the URL
        if (mno) {
            url += `/${mno}`;
        }
...
const exportPDF = async () => {
    ...
    try {
        ...
        const response = await axios.get(`/transferreportmypdf/${clientId.value}`, {
            headers: {
        ...
        const filename = `${today}_transferreportmy_${id}.pdf`;
    ...
    <section>
        ...
        <div class="app-hero-header d-flex align-items-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <RouterLink to="/transferreportmy" class="text-decoration-none">Transfers Report</RouterLink>
                </li>
        ...
        <div class="app-body">
            ...
            <div class="row" 
                v-if="
					menuAccess.transferReportMyMaskToggle ||
					menuAccess.transferReportMyExport
				">
                        ...
                        <div class="card-body p-2">
                            <div class="d-flex justify-content-end my-1 my-lg-0">
                                <div class="d-flex flex-row gap-2">
                                    <button v-if="menuAccess.transferReportMyMaskToggle" @click="toggleMask" class="btn btn-sm btn-info d-flex align-items-center gap-2">
                                    <i :class="isMasked ? 'bi-eye-slash' : 'bi-eye'"></i>
                                    {{ isMasked ? "Unmask" : "Mask" }}
                                    </button>
                                    <div class="d-flex" v-if="menuAccess.transferReportMyExport">
                                        <div class="dropdown">
